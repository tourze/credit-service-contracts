...
class CreditServiceExceptionTest extends TestCase
{
    /**
     * 测试异常基本构造函数
     */
    public function testConstructor_setsMessageCodeAndContext()
    {
        $message = '测试异常消息';
     ...
     * 测试创建余额不足异常
     */
    public function testInsufficientBalance_createsCorrectException()
    {
        $required = 1000;
        $available = 500;
     ...
     * 测试创建账户不存在异常
     */
    public function testAccountNotFound_createsCorrectException()
    {
     ...
     * 测试创建交易不存在异常
     */
    public function testTransactionNotFound_createsCorrectException()
    {
     ...
     * 测试创建交易状态错误异常
     */
    public function testInvalidTransactionStatus_createsCorrectException()
    {
     ...
     * 测试创建重复交易异常
     */
    public function testDuplicateTransaction_createsCorrectException()
    {
     ...
     * 测试创建账户已禁用异常
     */
    public function testAccountDisabled_createsCorrectException()
    {
     ...
     * 测试创建冻结积分不足异常
     */
    public function testInsufficientFrozen_createsCorrectException()
    {
     ...
     * 测试创建参数错误异常
     */
    public function testInvalidParameter_createsCorrectException()
    {
        $paramName = 'amount';
        $reason = '必须大于0';
        $context = ['value' => -100];
     ...
     * 测试创建版本冲突异常
     */
    public function testVersionConflict_createsCorrectException()
    {
     ...
     * 测试创建积分已过期异常
     */
    public function testCreditsExpired_createsCorrectException()
    {
     ...
     * 测试异常层次结构
     */
    public function testExceptionHierarchy_inheritsFromBaseException()
    {
     ...
     * 测试嵌套异常
     */
    public function testNestedException_preservesPreviousException()
    {
