...
interface CreditTransactionServiceInterface
{
     ...
     *
     * @return array<mixed> 交易记录列表和分页信息
     */
     ...
     * @param string|null                 $remark         备注
     *
     * @return array<mixed> 更新结果，包含成功和失败信息
     */
     ...
     * 记录操作日志
     *
     * @param array<string, mixed> $logData 日志数据
     *
     * @return string 日志ID
     */
     ...
     * @param array<string, mixed>  $data 不一致数据
     *
     * @return string 记录ID
     */
     ...
     * @param string $transactionId 交易ID
     *
     * @return array<string, mixed> 交易详情
     *
     * @throws CreditServiceException 交易不存在时抛出异常
     */
     ...
     * @param string $operationId 操作ID
     *
     * @return array<string, mixed> 操作日志详情
     */
     ...
     * @param int           $pageSize 每页数量
     *
     * @return array<mixed> 操作日志列表和分页信息
     */
     ...
     * @param int   $pageSize 每页数量
     *
     * @return array<mixed> 审计日志列表和分页信息
     */
     ...
     *
     * @param string $transactionId 交易ID
     * @param array<string, mixed>  $options       重试选项
     *
     * @return bool 重试是否成功
     *
     * @throws CreditServiceException 交易不存在或状态错误时抛出异常
     ...
     *
     * @param array<string, mixed> $filters 过滤条件，如积分类型、时间范围等
     *
     * @return array<string, mixed> 数据校验报告
     */
     ...
     *
     * @param array<string, mixed> $parameters 检测参数
     *
     * @return array<mixed> 风险警报列表
     */
